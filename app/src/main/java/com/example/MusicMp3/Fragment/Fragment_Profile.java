...
import com.example.MusicMp3.Activity.DangKyActivity;
...
public class Fragment_Profile extends Fragment implements Dialog_update_user.ExampleDialogListenerUpdateUser{
    ...
    public void apply(String tenUser, Bitmap bitmap) {
        ...
        if (bitmap != null){
            ...
            sql = "UPDATE tbNguoiDung SET Ten ='"+tenUser+"', ImageURL =  'https://musicappprj.000webhostapp.com/Hinhanh/Nguoidung/"+hm.getTaikhoan()+".jpg' WHERE TaiKhoan = '"+hm.getTaikhoan()+"'";
        }else {
